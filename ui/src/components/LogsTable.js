        ...
        <div className="ct-content">
          {logs.map((log, index) => (
            ...
            >
              ...
              <p
                style={{
                  fontSize: "12px", // smaller text for IP address
                  color: "#555",
                  marginBottom: "5px",
                }}
              >
              ...
              <p
                style={{
                  fontSize: "12px", // smaller text for User Agent
                  color: "#555",
                  marginBottom: "5px",
                }}
              >
              ...
              {/* Display other dynamic log details */}
              {log.other_details && (
                <>
                  {log.other_details.accept_language && (
                    <p
                      style={{
                        fontSize: "12px",
                        color: "#555",
                    ...
                    >
                      Accept Language: {log.other_details.accept_language}
                    </p>
                  )}
                  {log.other_details.referer && (
                    <p
                      style={{
                        fontSize: "12px",
                        color: "#555",
                    ...
                    >
                      Referer: {log.other_details.referer}
                    </p>
                  )}
                </>
              )}
